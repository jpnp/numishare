					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<div class="col-md-4 title-img">
								<img src="https://hcr.ashmus.ox.ac.uk/images/coin/70198of.jpg" class="img-responsive" style="clip-path: polygon(59% 0%, 77% 8%, 91% 26%, 99% 44%, 98% 65%, 88% 84%, 70% 98%, 49% 100%, 35% 97%, 19% 86%, 4% 69%, 1% 50%, 3% 34%, 11% 22%, 17% 12%, 27% 5%, 38% 0);"/>
							</div>
							<div class="col-md-6">
								<h1><xsl:value-of select="title"/></h1>
								<p><xsl:value-of select="description"/></p>
