...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:numishare="https://github.com/ewg118/numishare" version="2.0" exclude-result-prefixes="#all">
	...
	<xsl:template name="index">
		<div class="col-md-12">
			<img class="banner-img" src="{$include_path}/images/ChangeMap.jpg"/>
			<div class="carousel-caption" style="z-index:1;top:5%; color:white; text-shadow: 2px 3px 3px grey, 0px 0px 2px black, 0px 0px 4px black;;">
				<div class="">
			<h1 style="font-size:5em;"><xsl:value-of select="title"/></h1>

			<p class="title-desc" style="font-size:1.5em;"><xsl:value-of select="description"/></p>
		</div>
			</div>
